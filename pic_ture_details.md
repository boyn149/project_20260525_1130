# Picture Generation Details

## book1: เสน่ห์เงียบฉบับ INFJ: ดึงดูดคนที่ใช่ด้วยหัวใจที่เป็นตัวเอง
- **Total Images:** 2
- **Folder:** book/book_book1/pic_book1/

### Image 1
- **Sequence:** 1
- **File Name:** infographic_book1_1.png
...
### Image 2
- **Sequence:** 2
- **File Name:** infographic_book1_2.png
